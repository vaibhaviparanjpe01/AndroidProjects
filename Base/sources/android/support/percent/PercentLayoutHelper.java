...
public class PercentLayoutHelper {
    ...
    public static class PercentLayoutInfo {
        ...
        public void fillLayoutParams(ViewGroup.LayoutParams layoutParams, int i, int i2) {
            ...
            if (this.aspectRatio >= 0.0f) {
                if (z2) {
                    ...
                    boolean unused = this.mPreservedParams.mIsWidthComputedFromAspectRatio = true;
                }
                if (z) {
                    layoutParams.height = Math.round(((float) layoutParams.width) / this.aspectRatio);
                    boolean unused2 = this.mPreservedParams.mIsHeightComputedFromAspectRatio = true;
                }
            }
        }
        ...
        public void restoreLayoutParams(ViewGroup.LayoutParams layoutParams) {
            ...
            boolean unused = this.mPreservedParams.mIsWidthComputedFromAspectRatio = false;
            boolean unused2 = this.mPreservedParams.mIsHeightComputedFromAspectRatio = false;
        }
    }
}
