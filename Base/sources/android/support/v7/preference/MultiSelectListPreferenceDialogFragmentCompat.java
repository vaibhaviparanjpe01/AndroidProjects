    ...
    public void onPrepareDialogBuilder(AlertDialog.Builder builder) {
        ...
        builder.setMultiChoiceItems(this.mEntries, zArr, (DialogInterface.OnMultiChoiceClickListener) new DialogInterface.OnMultiChoiceClickListener() {
            public void onClick(DialogInterface dialogInterface, int i, boolean z) {
                if (z) {
                    boolean unused = MultiSelectListPreferenceDialogFragmentCompat.this.mPreferenceChanged = MultiSelectListPreferenceDialogFragmentCompat.this.mNewValues.add(MultiSelectListPreferenceDialogFragmentCompat.this.mEntryValues[i].toString()) | MultiSelectListPreferenceDialogFragmentCompat.this.mPreferenceChanged;
                    return;
                }
                boolean unused2 = MultiSelectListPreferenceDialogFragmentCompat.this.mPreferenceChanged = MultiSelectListPreferenceDialogFragmentCompat.this.mNewValues.remove(MultiSelectListPreferenceDialogFragmentCompat.this.mEntryValues[i].toString()) | MultiSelectListPreferenceDialogFragmentCompat.this.mPreferenceChanged;
            }
        });
    }
