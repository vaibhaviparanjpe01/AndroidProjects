...
public class UserBannerChooser implements AdFallbackHandler {
    private static final int MAX_FALLBACK_INDEX = Math.max(countAdServices(), 9);
    private static final String TAG = "UserBannerChooser";
    ...
    private static final boolean mAdsEnabled = (mAdMobEnabled || mAerServEnabled || mFacebookEnabled || mMillennialMediaEnabled || mJavascriptAdEnabled || mLeadBoltEnabled || mAmazonEnabled || mStartAppEnabled || mAirpushEnabled || mAirpush360Enabled || mStaticAdEnabled);
    ...
    private static final boolean mIsAndromoAd = false;
    ...
    private static int mStaticAdPercentage = -1;
    ...
    private BannerHelperBase getNextFallbackNetwork() {
        ...
        if (bannerHelperBase != null) {
            ...
            bannerHelperBase.setAndromoAd(false);
        }
    ...
    public com.newandromo.dev849565.app936843.BannerHelperBase getBannerHelper() {
        /*
            ...
            java.lang.String r0 = "UserBannerChooser"
        ...
        L_0x0113:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.newandromo.dev849565.app936843.UserBannerChooser.getBannerHelper():com.newandromo.dev849565.app936843.BannerHelperBase");
    }
    ...
    private static BannerHelperBase getAirpush360Helper() {
        if (mAirpush360Helper == null) {
            ...
            mAirpush360Helper.setAbstractBanner(true);
        }
    ...
    private static BannerHelperBase getStaticAdHelper() {
        if (mStaticAdHelper == null) {
            mStaticAdHelper = new StaticAdHelper(R.layout.static_ad_user, "http://www.andromo.com/?utm_source=static_banner&utm_medium=app&utm_campaign=andromo_app");
        }
