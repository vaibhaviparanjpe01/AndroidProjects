...
public class AboutUsMainBinding extends ViewDataBinding {
    @Nullable
    ...
    public AboutUsMainBinding(@NonNull DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    @NonNull
    public static AboutUsMainBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        return inflate(layoutInflater, viewGroup, z, DataBindingUtil.getDefaultComponent());
    }

    @NonNull
    public static AboutUsMainBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z, @Nullable DataBindingComponent dataBindingComponent) {
        return (AboutUsMainBinding) DataBindingUtil.inflate(layoutInflater, R.layout.about_us_main, viewGroup, z, dataBindingComponent);
    }

    @NonNull
    public static AboutUsMainBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, DataBindingUtil.getDefaultComponent());
    }

    @NonNull
    public static AboutUsMainBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable DataBindingComponent dataBindingComponent) {
        return bind(layoutInflater.inflate(R.layout.about_us_main, (ViewGroup) null, false), dataBindingComponent);
    }

    @NonNull
    public static AboutUsMainBinding bind(@NonNull View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    @NonNull
    public static AboutUsMainBinding bind(@NonNull View view, @Nullable DataBindingComponent dataBindingComponent) {
        if ("layout/about_us_main_0".equals(view.getTag())) {
