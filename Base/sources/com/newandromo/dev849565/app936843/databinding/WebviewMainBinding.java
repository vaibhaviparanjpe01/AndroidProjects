...
public class WebviewMainBinding extends ViewDataBinding {
    @Nullable
    ...
    public WebviewMainBinding(@NonNull DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    @NonNull
    public static WebviewMainBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        return inflate(layoutInflater, viewGroup, z, DataBindingUtil.getDefaultComponent());
    }

    @NonNull
    public static WebviewMainBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z, @Nullable DataBindingComponent dataBindingComponent) {
        return (WebviewMainBinding) DataBindingUtil.inflate(layoutInflater, R.layout.webview_main, viewGroup, z, dataBindingComponent);
    }

    @NonNull
    public static WebviewMainBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, DataBindingUtil.getDefaultComponent());
    }

    @NonNull
    public static WebviewMainBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable DataBindingComponent dataBindingComponent) {
        return bind(layoutInflater.inflate(R.layout.webview_main, (ViewGroup) null, false), dataBindingComponent);
    }

    @NonNull
    public static WebviewMainBinding bind(@NonNull View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    @NonNull
    public static WebviewMainBinding bind(@NonNull View view, @Nullable DataBindingComponent dataBindingComponent) {
